...
const JeselTransformation = () => {
    return (
        <CaseStudyLayout
            ...
            heroImage="/images/jesel/Header1.png"
        >
            <div className="space-y-32">
                <section>
                    <div className="rounded-2xl overflow-hidden shadow-sm  bg-transparent">
                        <img src="/images/jesel/Header1.png" alt="Digital Business Transformation" className="w-full h-auto" />
                    </div>
                </section>
                ...
                <section className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-24">
                    ...
                    <div className="md:col-span-4 bg-transparent p-8 rounded-2xl  h-fit">
                        <h3 className="text-2xl font-semibold mb-6">TL;DR</h3>
                        <ul className="space-y-4 text-lg">
                            <li className="flex items-start"><span className="mr-3 font-semibold text-primary">•</span>9x increase in organic search visibility</li>
                            <li className="flex items-start"><span className="mr-3 font-semibold text-primary">•</span>230% increase in organic traffic</li>
                            <li className="flex items-start"><span className="mr-3 font-semibold text-primary">•</span>45% increase in time on site</li>
                            <li className="flex items-start"><span className="mr-3 font-semibold text-primary">•</span>From 0 to 41k engaged email subscribers (8% CTR)</li>
                            <li className="flex items-start"><span className="mr-3 font-semibold text-primary">•</span>#1 authority in Premium Valvetrain market</li>
                        </ul>
                    </div>
                </section>
                ...
                <section className="max-w-4xl mx-auto space-y-16">
                    <div>
                        <h2 className="text-3xl font-semibold mb-6">The Approach</h2>
                    ...
                    <div>
                        <h2 className="text-3xl font-semibold mb-6">Elevating the Brand</h2>
                        <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                ...
                <section>
                    <div className="rounded-2xl overflow-hidden shadow-sm  bg-transparent">
                        <img src="/images/jesel/ad-mockup7.png" alt="Ad Mockup" className="w-full h-auto " />
                    </div>
                    <p className="text-muted-foreground italic mt-4 text-center">By reversing the visual conventions, replacing aggression with clarity and clutter with space, we elevated Jesel above the competition's noise and positioned it as the only truly premium valve train manufacturer in the industry.</p>
                </section>

                <section className="max-w-4xl mx-auto space-y-8">
                    <h2 className="text-3xl font-semibold mb-6">Outranking the Competition</h2>
                    <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                ...
                <section>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="rounded-2xl overflow-hidden shadow-sm  bg-transparent flex items-center">
                            <img src="/images/jesel/googleresults.png" alt="Google Search Results" className="w-full h-auto " />
                        </div>
                        <div className="rounded-2xl overflow-hidden shadow-sm  bg-transparent flex flex-col items-center">
                            <img src="/images/jesel/SEO.png" alt="SEO Results" className="w-full h-auto " />
                        </div>
                    </div>
                    <p className="text-muted-foreground italic mt-4 text-center">Our aggressive focus on SEO optimization turned Jesel's site into a high performing organic channel, consistently ranking at the top of Google searches.</p>
                </section>

                <section className="max-w-4xl mx-auto space-y-8">
                    <h2 className="text-3xl font-semibold mb-6">Building Reach</h2>
                    <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                ...
                <section>
                    <div className="rounded-2xl overflow-hidden shadow-sm  bg-transparent">
                        <img src="/images/jesel/EmailGroup.png" alt="Email Campaigns" className="w-full h-auto " />
                    </div>
                    <p className="text-muted-foreground italic mt-4 text-center">Targeted email campaigns became a key source of engagement and the dramatic increase in site traffic during campaigns was tracked directly through to calls and orders.</p>
                </section>

                <section className="max-w-4xl mx-auto space-y-12">
                    <h2 className="text-3xl font-semibold">The Results</h2>
                ...
                <section className="max-w-4xl mx-auto space-y-8 bg-transparent p-8 md:p-12 rounded-3xl ">
